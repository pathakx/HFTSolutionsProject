...
This submission also includes the following additional files:

| File | Purpose |
|------|---------|
| `main.py` | Runs the complete demonstration workflow |
| `benchmark.py` | Measures optimizer runtime performance |
| `walk_forward.py` | Performs simple out-of-sample validation |
| `PROJECT_RUN.md` | Contains setup and execution instructions |
| `NOTES.md` | Documents implementation details, tradeoffs, and future improvements |

---

# AI Assistance Disclosure

AI tools were used for brainstorming implementation ideas, discussing optimization approaches, and reviewing edge cases. All final code was reviewed, modified, tested, and integrated manually.